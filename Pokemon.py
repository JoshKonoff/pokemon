...
p_list = ['ratata', 'pikachu', 'charmander', 'magikarp', 'ditto', 'snorlax', 'eevee', 'dragonite', 'koffing', 'weezing', 'moltres', 'kadabra', 'articuno', 'ghastly', 'ekans', 'meowth', 'lucario', 'bulbasaur', 'articuno', 'zapdos', 'mew']
